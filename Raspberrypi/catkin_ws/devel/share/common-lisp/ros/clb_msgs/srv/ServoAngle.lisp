...
(cl:defmethod cl:initialize-instance :after ((m <ServoAngle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoAngle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clb_msgs-srv:<ServoAngle-request> is deprecated: use clb_msgs-srv:ServoAngle-request instead.")))

(cl:ensure-generic-function 'Servo1-val :lambda-list '(m))
(cl:defmethod Servo1-val ((m <ServoAngle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-srv:Servo1-val is deprecated.  Use clb_msgs-srv:Servo1 instead.")
  (Servo1 m))

(cl:ensure-generic-function 'Servo2-val :lambda-list '(m))
(cl:defmethod Servo2-val ((m <ServoAngle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-srv:Servo2-val is deprecated.  Use clb_msgs-srv:Servo2 instead.")
  (Servo2 m))
...
(cl:defmethod cl:initialize-instance :after ((m <ServoAngle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoAngle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clb_msgs-srv:<ServoAngle-response> is deprecated: use clb_msgs-srv:ServoAngle-response instead.")))
