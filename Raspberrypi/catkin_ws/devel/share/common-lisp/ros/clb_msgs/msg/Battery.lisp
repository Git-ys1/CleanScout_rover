...
(cl:defmethod cl:initialize-instance :after ((m <Battery>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Battery)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clb_msgs-msg:<Battery> is deprecated: use clb_msgs-msg:Battery instead.")))

(cl:ensure-generic-function 'battery-val :lambda-list '(m))
(cl:defmethod battery-val ((m <Battery>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:battery-val is deprecated.  Use clb_msgs-msg:battery instead.")
  (battery m))
