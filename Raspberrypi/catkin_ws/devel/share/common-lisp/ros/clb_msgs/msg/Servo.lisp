...
(cl:defmethod cl:initialize-instance :after ((m <Servo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clb_msgs-msg:<Servo> is deprecated: use clb_msgs-msg:Servo instead.")))

(cl:ensure-generic-function 'Servo1-val :lambda-list '(m))
(cl:defmethod Servo1-val ((m <Servo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:Servo1-val is deprecated.  Use clb_msgs-msg:Servo1 instead.")
  (Servo1 m))

(cl:ensure-generic-function 'Servo2-val :lambda-list '(m))
(cl:defmethod Servo2-val ((m <Servo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:Servo2-val is deprecated.  Use clb_msgs-msg:Servo2 instead.")
  (Servo2 m))
