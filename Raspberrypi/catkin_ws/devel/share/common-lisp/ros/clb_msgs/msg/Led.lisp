...
(cl:defmethod cl:initialize-instance :after ((m <Led>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Led)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clb_msgs-msg:<Led> is deprecated: use clb_msgs-msg:Led instead.")))

(cl:ensure-generic-function 'LED1-val :lambda-list '(m))
(cl:defmethod LED1-val ((m <Led>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:LED1-val is deprecated.  Use clb_msgs-msg:LED1 instead.")
  (LED1 m))

(cl:ensure-generic-function 'LED2-val :lambda-list '(m))
(cl:defmethod LED2-val ((m <Led>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:LED2-val is deprecated.  Use clb_msgs-msg:LED2 instead.")
  (LED2 m))

(cl:ensure-generic-function 'LED3-val :lambda-list '(m))
(cl:defmethod LED3-val ((m <Led>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:LED3-val is deprecated.  Use clb_msgs-msg:LED3 instead.")
  (LED3 m))
