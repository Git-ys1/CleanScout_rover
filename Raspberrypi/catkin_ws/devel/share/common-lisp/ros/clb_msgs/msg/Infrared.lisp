...
(cl:defmethod cl:initialize-instance :after ((m <Infrared>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Infrared)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clb_msgs-msg:<Infrared> is deprecated: use clb_msgs-msg:Infrared instead.")))
...
(cl:defmethod rear-val ((m <Infrared>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:rear-val is deprecated.  Use clb_msgs-msg:rear instead.")
  (rear m))
