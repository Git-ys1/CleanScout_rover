...
(cl:defmethod cl:initialize-instance :after ((m <Buzzer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Buzzer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clb_msgs-msg:<Buzzer> is deprecated: use clb_msgs-msg:Buzzer instead.")))

(cl:ensure-generic-function 'BUZZER1-val :lambda-list '(m))
(cl:defmethod BUZZER1-val ((m <Buzzer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:BUZZER1-val is deprecated.  Use clb_msgs-msg:BUZZER1 instead.")
  (BUZZER1 m))
