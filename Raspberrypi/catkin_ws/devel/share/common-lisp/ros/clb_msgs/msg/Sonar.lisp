...
(cl:defmethod cl:initialize-instance :after ((m <Sonar>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sonar)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clb_msgs-msg:<Sonar> is deprecated: use clb_msgs-msg:Sonar instead.")))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Sonar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:distance-val is deprecated.  Use clb_msgs-msg:distance instead.")
  (distance m))
