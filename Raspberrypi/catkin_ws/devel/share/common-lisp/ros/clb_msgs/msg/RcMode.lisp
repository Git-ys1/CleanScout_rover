...
(cl:defmethod cl:initialize-instance :after ((m <RcMode>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RcMode)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clb_msgs-msg:<RcMode> is deprecated: use clb_msgs-msg:RcMode instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <RcMode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:mode-val is deprecated.  Use clb_msgs-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'vel-val :lambda-list '(m))
(cl:defmethod vel-val ((m <RcMode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:vel-val is deprecated.  Use clb_msgs-msg:vel instead.")
  (vel m))
