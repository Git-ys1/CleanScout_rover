...
(cl:defmethod cl:initialize-instance :after ((m <DHT22>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DHT22)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clb_msgs-msg:<DHT22> is deprecated: use clb_msgs-msg:DHT22 instead.")))

(cl:ensure-generic-function 'Temperature-val :lambda-list '(m))
(cl:defmethod Temperature-val ((m <DHT22>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:Temperature-val is deprecated.  Use clb_msgs-msg:Temperature instead.")
  (Temperature m))

(cl:ensure-generic-function 'Humidity-val :lambda-list '(m))
(cl:defmethod Humidity-val ((m <DHT22>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clb_msgs-msg:Humidity-val is deprecated.  Use clb_msgs-msg:Humidity instead.")
  (Humidity m))
