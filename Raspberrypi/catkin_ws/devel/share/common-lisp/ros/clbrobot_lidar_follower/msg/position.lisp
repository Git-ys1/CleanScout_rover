...
(cl:in-package clbrobot_lidar_follower-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clbrobot_lidar_follower-msg:<position> is deprecated: use clbrobot_lidar_follower-msg:position instead.")))

(cl:ensure-generic-function 'angleX-val :lambda-list '(m))
(cl:defmethod angleX-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clbrobot_lidar_follower-msg:angleX-val is deprecated.  Use clbrobot_lidar_follower-msg:angleX instead.")
  (angleX m))

(cl:ensure-generic-function 'angleY-val :lambda-list '(m))
(cl:defmethod angleY-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clbrobot_lidar_follower-msg:angleY-val is deprecated.  Use clbrobot_lidar_follower-msg:angleY instead.")
  (angleY m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clbrobot_lidar_follower-msg:distance-val is deprecated.  Use clbrobot_lidar_follower-msg:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<position>)))
  ...
  "clbrobot_lidar_follower/position")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'position)))
  "Returns string type for a message object of type 'position"
  "clbrobot_lidar_follower/position")
