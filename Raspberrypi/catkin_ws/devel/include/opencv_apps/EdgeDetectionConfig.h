...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(EdgeDetectionConfig::AbstractParamDescriptionConstPtr(new EdgeDetectionConfig::ParamDescription<int>("edge_type", "int", 0, "Edge Detection Methods", "{'enum': [{'name': 'Sobel', 'type': 'int', 'value': 0, 'srcline': 42, 'srcfile': '/home/clbrobot/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'description': 'Sobel Derivatives', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Laplace', 'type': 'int', 'value': 1, 'srcline': 43, 'srcfile': '/home/clbrobot/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'description': 'Laplace Operator', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Canny', 'type': 'int', 'value': 2, 'srcline': 44, 'srcfile': '/home/clbrobot/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'description': 'Canny Edge Detector', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum for Edge Detection Mehtods'}", &EdgeDetectionConfig::edge_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(EdgeDetectionConfig::AbstractParamDescriptionConstPtr(new EdgeDetectionConfig::ParamDescription<int>("edge_type", "int", 0, "Edge Detection Methods", "{'enum': [{'name': 'Sobel', 'type': 'int', 'value': 0, 'srcline': 42, 'srcfile': '/home/clbrobot/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'description': 'Sobel Derivatives', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Laplace', 'type': 'int', 'value': 1, 'srcline': 43, 'srcfile': '/home/clbrobot/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'description': 'Laplace Operator', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Canny', 'type': 'int', 'value': 2, 'srcline': 44, 'srcfile': '/home/clbrobot/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'description': 'Canny Edge Detector', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum for Edge Detection Mehtods'}", &EdgeDetectionConfig::edge_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 42 "/home/clbrobot/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg"
      const int EdgeDetection_Sobel = 0;
//#line 43 "/home/clbrobot/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg"
      const int EdgeDetection_Laplace = 1;
//#line 44 "/home/clbrobot/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg"
