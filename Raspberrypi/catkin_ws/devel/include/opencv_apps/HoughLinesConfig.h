...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(HoughLinesConfig::AbstractParamDescriptionConstPtr(new HoughLinesConfig::ParamDescription<int>("hough_type", "int", 0, "Hough Line Methods", "{'enum': [{'name': 'Standard_Hough_Transform', 'type': 'int', 'value': 0, 'srcline': 42, 'srcfile': '/home/clbrobot/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg', 'description': 'Standard Hough Line', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Probabilistic_Hough_Transform', 'type': 'int', 'value': 1, 'srcline': 43, 'srcfile': '/home/clbrobot/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg', 'description': 'Probabilistic Hough Line', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum for Hough Transform Mehtods'}", &HoughLinesConfig::hough_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(HoughLinesConfig::AbstractParamDescriptionConstPtr(new HoughLinesConfig::ParamDescription<int>("hough_type", "int", 0, "Hough Line Methods", "{'enum': [{'name': 'Standard_Hough_Transform', 'type': 'int', 'value': 0, 'srcline': 42, 'srcfile': '/home/clbrobot/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg', 'description': 'Standard Hough Line', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Probabilistic_Hough_Transform', 'type': 'int', 'value': 1, 'srcline': 43, 'srcfile': '/home/clbrobot/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg', 'description': 'Probabilistic Hough Line', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum for Hough Transform Mehtods'}", &HoughLinesConfig::hough_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 42 "/home/clbrobot/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg"
      const int HoughLines_Standard_Hough_Transform = 0;
//#line 43 "/home/clbrobot/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg"
