...
"""autogenerated by genpy from clb_msgs/TrajectoryRequest.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryRequest(genpy.Message):
  ...
  _type = "clb_msgs/TrajectoryRequest"
...
def _get_struct_6h():
    ...
    return _struct_6h
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from clb_msgs/TrajectoryResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class TrajectoryResponse(genpy.Message):
  ...
  _type = "clb_msgs/TrajectoryResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """"""
  __slots__ = []
  _slot_types = []
