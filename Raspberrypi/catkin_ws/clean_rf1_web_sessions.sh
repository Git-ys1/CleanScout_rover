...
ps -ef | grep -E 'roscore|rosmaster|roslaunch|rosbridge_websocket|rf1_serial_bridge.py|cmdvel_to_rf1.py|rf1_vel_to_odom.py|edge_relay.py|scan_contract_stub.py|mpu6050_node.py|rplidarNode' | grep -v grep || true
