...
typedef enum
{
    CSR_ENCODER_INPUT_FLOATING = 0,
    CSR_ENCODER_INPUT_IPU = 1,
    CSR_ENCODER_INPUT_IPD = 2
} csr_encoder_input_mode_t;

typedef enum
{
    CSR_ENCODER_COUNT_TI12 = 0,
    CSR_ENCODER_COUNT_TI1 = 1,
    CSR_ENCODER_COUNT_TI2 = 2
} csr_encoder_count_mode_t;
